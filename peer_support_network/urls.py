...
urlpatterns = [
    ...
    path('settings/other_users/', views.OtherUserSettingsView.as_view(), name='other_users'),
    ...
    path('user_profile/<str:username>/', views.OtherUserProfileView.as_view(), name='other_user_profile'),
