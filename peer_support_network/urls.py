...
urlpatterns = [
    ...
    path('customisation/', views.CustomisationView.as_view(), name='customisation'),
    ...
    path('settings/feedback/', views.SubmitFeedbackView.as_view(), name='submit_feedback'),
    ...
    path('peer_select/', views.PeerSelectView.as_view(), name='peer_select'),
    ...
    path('moderation/feedback', views.FeedbackView.as_view(), name='feedback'),
