...
from peer_support.forms import LogInForm
from peer_support.models import User
from peer_support.tests.helpers import LogInTester, MenuTesterMixin, reverse_with_next
...
class LogInViewTestCase(TestCase, LogInTester, MenuTesterMixin):
    ...
    def test_get_log_in_with_redirect(self):
        destination_url = reverse('settings')
